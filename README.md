# AfriDataHub - Kanuri Language Dataset Repository

Welcome to the AfriDataHub Kanuri repository! This repository is dedicated to building high-quality language datasets and natural language processing (NLP) tools for the Kanuri language, as part of AfriDataHub’s mission to enhance digital inclusion for African languages. Our goal is to create resources that enable culturally relevant AI applications in Kanuri.
...
- Building parallel corpora for machine translation between Kanuri and English.
...
- `models/`: Pre-trained NLP models for Kanuri, such as machine translation and language models.
...
To get started with using the datasets and models for Kanuri, please refer to our [Usage Guide](docs/usage.md) for detailed instructions on accessing and utilizing these resources.
...
3. Sharing knowledge on Kanuri grammar, syntax, and vocabulary.
